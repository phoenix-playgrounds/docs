...
sidebar_position: 1
title: Огляд
description: Початок роботи з REST API Playgrounds.dev — автентифікація, скоупи та обробка помилок.
---

# Огляд API

Playgrounds.dev API — це RESTful JSON API, що надає програмний доступ до всіх ресурсів платформи. Використовуйте його для автоматизації створення середовищ, інтеграції з CI/CD пайплайнами або побудови власних інструментів.
