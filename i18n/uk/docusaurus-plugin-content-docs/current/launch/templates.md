...
2. **Оголошення змінних** — Секція `playgrounds.dev` з вкладеним блоком `variables`, що декларує всі змінні у шаблоні
...
Кожна змінна, що використовується в тілі шаблону, **повинна** бути оголошена в секції `playgrounds.dev > variables`, і кожна оголошена змінна **повинна** бути використана хоча б раз. Платформа перевіряє цю відповідність при створенні версії.
