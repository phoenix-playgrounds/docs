...
2. **Оголошення змінних** — Спеціальна секція `playground-variables`, що декларує всі змінні у шаблоні
...
Кожна змінна, що використовується в тілі шаблону, **повинна** бути оголошена в секції `playground-variables`, і кожна оголошена змінна **повинна** бути використана хоча б раз. Платформа перевіряє цю відповідність при створенні версії.
