...
:::info Тільки GitHub
Playgrounds.dev наразі підтримує лише репозиторії **GitHub**. Підтримка інших Git-провайдерів планується на майбутнє.
:::
...
Рекомендований спосіб підключення репозиторіїв — через **Playgrounds.dev GitHub App**. Після встановлення на вашу GitHub-організацію або персональний акаунт, застосунок надає:
...
| Ліміт | Значення |
|-------|---------|
| Максимум Playzone на акаунт | **20** |
